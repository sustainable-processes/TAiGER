...
def create_pyomo_model(input_profile):
   ...
   m.compartment2_ord_ip_aq = Param(m.i, m.p, initialize={(1, 1): 1, (2, 1): 1, (3, 1): 0, (4, 1): 0, (5, 1): 0, (6, 1): 0})
   ...
   m.compartment2_Tref_aq = Param(m.p, initialize={1: 317.3})
   ...
   m.compartment2_k0_aq = Param(m.p, initialize={1: 0.0126092})
   ...
   m.compartment2_nu_ip_aq = Param(m.i, m.p, initialize={(1, 1): -1, (2, 1): -1, (3, 1): 1, (4, 1): 1, (5, 1): 0, (6, 1): 0})
   m.compartment2_E_aq = Param(m.p, initialize={1: 70111})
   ...
   m.compartment2_k_aq = Var(m.p, m.n, bounds=(0,20))
   ...
   m.compartment2_r_aq = Var(m.p, m.n, bounds=(0,1))
   ...
   m.compartment2_phase1R = Var(m.i, m.p, m.n, bounds=(-1,1))
   ...
   # Define equations
   def _eq1_rule(m, i, n):
      return (m.interface12_F_conv[i,n] == (m.interface9_F_conv[i,n] + m.interface1_F_conv[i]))
   m.eq1 = Constraint(m.i, m.n, rule=_eq1_rule)

   def _eq2_rule(m, i, n):
      return (m.interface12_V_dot_conv[n] == (m.interface9_V_dot_conv[n] + m.interface1_V_dot_conv))
   m.eq2 = Constraint(m.i, m.n, rule=_eq2_rule)

   def _eq3_rule(m, i, p, n):
      return (0 == ((m.interface13_F_conv[i,n] - m.interface5_F_conv[i,n]) + ((m.compartment2_V * m.compartment2_phase1R[i,p,n]) + (m.compartment2_V * m.compartment2_phase2R[i,p,n]))))
   m.eq3 = Constraint(m.i, m.p, m.n, rule=_eq3_rule)

   def _eq4_rule(m, n):
      return (m.interface13_V_dot_conv[n] == m.interface5_V_dot_conv[n])
   m.eq4 = Constraint(m.n, rule=_eq4_rule)

   def _eq5_rule(m, i, p, n):
      return (0 == ((m.interface8_F_conv[i] - m.interface9_F_conv[i,n]) + (m.compartment5_V * m.compartment5_phase2R[i,p,n])))
   ...
   def _eq7_rule(m, i, p, n):
      return (0 == ((m.interface12_F_conv[i,n] - m.interface13_F_conv[i,n]) + ((m.compartment8_V * m.compartment8_phase1R[i,p,n]) + (m.compartment8_V * m.compartment8_phase2R[i,p,n]))))
   ...
   def _eq13_rule(m, i, p, n):
      return (0 == (sum((m.compartment2_r_aq[p,n] * m.compartment2_nu_ip_aq[i,p]) for p in range(1,1+input_profile['sets']['p']['max'])) - m.compartment2_phase1R[i,p,n]))
   ...
   def _eq15_rule(m, p, n):
      return (0 == ((m.compartment2_k_aq[p,n] * prod(((m.interface5_F_conv[i,n] / m.interface13_V_dot_conv[n]) ** m.compartment2_ord_ip_aq[i,p]) for i in range(1,1+input_profile['sets']['i']['max']))) - m.compartment2_r_aq[p,n]))
   m.eq15 = Constraint(m.p, m.n, rule=_eq15_rule)

   def _eq16_rule(m, p, n):
      return (0 == ((m.compartment5_k_org[p,n] * prod(((m.interface9_F_conv[i,n] / m.interface8_V_dot_conv) ** m.compartment5_ord_ip_org[i,p]) for i in range(1,1+input_profile['sets']['i']['max']))) - m.compartment5_r_org[p,n]))
   m.eq16 = Constraint(m.p, m.n, rule=_eq16_rule)

   def _eq17_rule(m, p, n):
      return (0 == ((m.compartment2_k_org[p,n] * prod(((m.interface5_F_conv[i,n] / m.interface13_V_dot_conv[n]) ** m.compartment2_ord_ip_org[i,p]) for i in range(1,1+input_profile['sets']['i']['max']))) - m.compartment2_r_org[p,n]))
   m.eq17 = Constraint(m.p, m.n, rule=_eq17_rule)

   def _eq18_rule(m, p, n):
      return (0 == ((m.compartment8_k_aq[p,n] * prod(((m.interface13_F_conv[i,n] / m.interface12_V_dot_conv[n]) ** m.compartment8_ord_ip_aq[i,p]) for i in range(1,1+input_profile['sets']['i']['max']))) - m.compartment8_r_aq[p,n]))
   ...
   def _eq20_rule(m, p, n):
      return (m.compartment2_k_aq[p,n] == (m.compartment2_k0_aq[p] * exp((((0 - m.compartment2_E_aq[p]) / 8.314) * ((1 / m.environment_Tc[n]) - (1 / m.compartment2_Tref_aq[p]))))))
